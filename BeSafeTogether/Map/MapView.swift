...
final class MapViewModel: NSObject, ObservableObject, CLLocationManagerDelegate {
    ...
    @Published var region = MKCoordinateRegion(center: CLLocationCoordinate2D(latitude: 43.25667, longitude: 76.92861), span: MKCoordinateSpan(latitudeDelta: 0.1, longitudeDelta: 0.1))
